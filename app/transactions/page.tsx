...
const TransactionPage = () => {
  ...
  return (
    <div className="p-4 md:p-8 max-w-7xl mx-auto space-y-6 relative animate-in fade-in duration-500 bg-background text-foreground transition-colors duration-300">
      {/* হেডার সেকশন */}
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex flex-col gap-1">
          <h1 className="text-2xl font-black text-foreground italic tracking-tight uppercase">
            Transaction History
          </h1>
      ...
      <div className="w-full">
        {isLoading ? (
          ...
          /* Empty State - ডার্ক মোড ফ্রেন্ডলি করা হয়েছে */
          <div className="text-center py-20 bg-card-bg rounded-[32px] border-2 border-dashed border-border-custom">
